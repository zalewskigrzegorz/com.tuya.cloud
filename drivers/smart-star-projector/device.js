...
class TuyaStarProjectorDevice extends TuyaBaseDevice {
  ...
  onInit() {
    ...
    this.log(`Tuya star projector ${this.getName()} has been initialized`);
  }
  ...
  getSendParam(name, value, value2) {
    ...
    this.log("update Tuya projector code " + code + ": " + JSON.stringify(value));
    return {
      "commands": [
        {
          "code": code,
...
module.exports = TuyaStarProjectorDevice;
